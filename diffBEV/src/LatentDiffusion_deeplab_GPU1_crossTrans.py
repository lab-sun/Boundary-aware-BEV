...
from diffBEV.nets.attention_GPU3 import SpatialTransformer, CrossTransformer
...
save_root = './sampling_img/DiffBEV_GPU1_crossTrans'
text_save_root = os.path.join('./logs/DiffBEV_GPU1_crossTrans', create_time)
