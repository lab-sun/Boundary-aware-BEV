...
save_root = './sampling_img/DiffBEV_GPU1'
...
class LatentDiffusionConditional(LatentDiffusion):
    ...
    def training_step(self, batch, batch_idx):  # 先调用
        ...
        # 分割损失
        seg_loss = self.seg_loss_fn(opt, seg_pred, bev_labels, t, self.num_timesteps)
    ...
    def test_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            # 加mask
            label, pred = get_mask(intrins, out, bev_labels, opt)
