...
def get_args():
    ...
    parser.add_argument("--label_list", type=list, default=label_list,
                        help="label_list")
    class_weights = [3.17794119, 2.5617616, 23.64493676,  7.09298426, 45.14709186, 18.77214296, 48.18801878]  # [1.65354177e+08, 2.16264827e+08, 1.09664220e+07, 6.21162590e+07, 1.13304400e+06, 1.64097850e+07, 4.57986000e+05]
    parser.add_argument("--class_weights", type=list, default=class_weights,
                        help="class weights")
    ...
    parser.add_argument("--if_save_img", default=True, action='store_false',
    ...
    parser.add_argument("--if_BoundaryLoss", action='store_true', default=False, # 默认不计算
                        help="Whether to save test img")
    parser.add_argument('--boundaryLoss_gamma', type=float, default=1.5,
                        help='gamma for boundary loss weight calucation')
    parser.add_argument("--if_Vshape", action='store_true', default=False,  # 默认不计算
                        help="Whether to save test img")
    ...
    parser.add_argument("--num_timesteps", type=int, default=1000,  # 记得在/guided_diffusion/script_util.py中做同步修改
                        help="the timesteps to sample")
    ...
    # TODO 将字典转成parser
    parser.add_argument("--defaults", type=dict, default=defaults,
                        help="defaults params for diffusion")
