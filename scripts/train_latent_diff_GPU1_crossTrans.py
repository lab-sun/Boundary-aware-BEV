...
from diffBEV.src.LatentDiffusion_deeplab_GPU1_crossTrans import LatentDiffusionConditional
...
if __name__ == '__main__':
    ...
    # lr = 0.005
    # batch_size = 48
    log_root = './logs/DiffBEV_GPU1_crossTrans'
    log_frequency = 10
    ckpt_root = './pretrain_weights/DiffBEV_GPU1_crossTrans/'
    save_frequency = 1
    ...
    logger = TensorBoardLogger('logs', name='DiffBEV_GPU1_crossTrans/{}/'.format(create_time))
